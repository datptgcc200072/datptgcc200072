	   ...
	   if(isset($_POST['btnThemMoi'])){
	   	...
	   	if(trim($TenSP=="")){
	   		...
	   		if(pg_num_rows($sql)==0){
	   			$Today=date('Y-m-d');
	   			pg_query($Connect,"INSERT INTO sanpham(SP_Ten, SP_GiaHienTai, SP_SoLuong, SP_MoTa, SP_MoTa_ChiTiet, LSP_Ma,NSX_Ma,SP_NgayCapNhat) VALUES('$TenSP','$Gia','$SL','$MoTaNgan','$MoTaDai','$LoaiSP','$NhaSX','$Today')") or die(pg_error($Connect));
