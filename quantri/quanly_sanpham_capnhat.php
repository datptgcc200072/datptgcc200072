...
if(isset($_GET['ma'])){
	...
	if(isset($_POST['btnCapNhat'])){
		...
		if(trim($TenSP=="")){
			...
			pg_query($Connect,"UPDATE sanpham SET SP_Ten = '$TenSP', LSP_Ma = '$LoaiSP', NSX_Ma = '$NhaSX', SP_GiaHienTai = '$Gia', SP_MoTa = '$MoTaNgan', SP_MoTa_ChiTiet = '$MoTaDai', SP_SoLuong = '$SL' where SP_Ma = '$Ma'") or die(pg_error($Connect));
